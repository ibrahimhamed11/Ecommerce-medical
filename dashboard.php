...
<body>
    <div class="page d-flex">
        <div id="side" class="sidebar">
            ...
            <ul>
                <li>
                    <a class="active d-flex align-items-center" href="dashboard.html">
        ...
        <div class="content">
                ...
                <div class="responsive-table">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="images/patient-1 (1).jpg" alt="" />
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="images/patient-5.jpg" alt="" />
                                </td>
                                <td>Jenni</td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="images/patient-6.jpg" alt="" />
                                </td>
                                <td>John Doe</td>
                                <td>Dr. Andrew</td>
                                <td>01 Dec 2023</td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="images/patient-8.jpg" alt="" />
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="rounded-circle" src="images/patient-1.jpg" alt="" />
                                </td>
                                <td>Bernardo Galaviz</td>
                                <td>Dr. Cristina Groves</td>
                                <td>01 Dec 2023</td>
            ...
            <div class="container p-4">
                <div class="row">
                    <div class="list-group col-xl-3 col-l-3 col-md-12 col-sm-12 p-0">
                        <ul class="p-0 m-0">
                            ...
                            <li class="list-group-item">
                                <img class="rounded-circle" src="images/doctor-1.jpg" alt="" />
                    ...
                    <div class="col-xl-6 col-l-6 col-md-12 col-sm-12">
                        <iframe class="w-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29138.08383720805!2d32.91761581994239!3d24.092333602987626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14367b5ab1a30e5f%3A0xfb109fe337cabccb!2z2KPYs9mI2KfZhg!5e0!3m2!1sar!2seg!4v1675864765900!5m2!1sar!2seg"

    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse col-7 justify-content-end" id="navbarTogglerDemo02">
        <ul class="navbar-nav  mb-2 mb-lg-0">
          ...
          <li class="nav-item align-self-center">
            <a class="nav-link  p-lg-2" href="product.html">PHARMACEIES PROFILE</a>
          </li>
          <li class="nav-item align-self-center">
  ...
  <section class="join" id="join">
    <div class="container">
      <div class="p-3">
        ...
        <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur deleniti magni, debitis optio</p>
      </div>
            ...
            <div class="card-body">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu  border-primary ">
                  <li><a class="dropdown-item text-black-50" href="DoctorForm.php" target="_blank">create new account</a></li>
                  <button type="button>" class="dropdown-item text-black-50" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">I already have an account</button>
                </ul>
                      ...
                      <div class="modal-body">
                        ...
                        <form method="post">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control" id="message-password"></input>
                          </div>
                          <div class="modal-footer">
                            <input type="reset" value="close" data-bs-dismiss="modal" class="btn btn-outline-primary p-2 text-light">
                            <input type="submit" value="login" class="btn btn-primary p-2 text-light">
                          </div>
                        </form>
                      </div>
          ...
          <div class="card h-100 p-2 text-center">
            <div class="card-body">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu border-primary">
                  <li><a class="dropdown-item text-black-50 " href="PharmacyForm.php" target="_blank">create new account</a></li>
                  <button type="button>" class="dropdown-item text-black-50" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">I already have an account</button>
                </ul>
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <div class="modal-body ">
                        ...
                        <form>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="message-password"></input>
                          </div>
                          <div class="modal-footer">
                            <input type="reset" value="close" data-bs-dismiss="modal" class="btn btn-outline-primary p-2 text-light">
                            <input type="submit" value="login" class="btn btn-primary p-2 text-light">
          ...
          <div class="card h-100 p-2 text-center">
            <div class="card-body">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu border-primary">
                  <li><a class="dropdown-item text-black-50 " href="userForm.php" target="_blank">create new account</a></li>
                  <button type="button>" class="dropdown-item text-black-50" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">I already have an account</button>
                </ul>
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
    ...
    <div class="container p-3">
      ...
      <div class="text-center pl-4">
        <div class="container" style="border-top: 1px solid white">
          <!-- Twitter -->
          <a class="btn btn-link btn-floating btn-lg text-dark mt-2" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-twitter"></i></a>

          <!-- Facebook -->
          <a class="btn btn-link btn-floating btn-lg text-dark mt-2" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-facebook-f"></i></a>

          <!-- Instagram -->
          <a class="btn btn-link btn-floating btn-lg text-dark mt-2" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-instagram"></i></a>

          <!-- Linkedin -->
          <a class="btn btn-link btn-floating btn-lg text-dark mt-2" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-linkedin"></i></a>

          <!-- Google -->
          <a class="btn btn-link btn-floating btn-lg text-dark mt-2" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-google"></i></a>
        </div>
      </div>
      <!-- Icons -->
    </div>

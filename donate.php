    ...
    <div class="popup1">
      <div class="form-container">
        ...
        <form method="post" action="" id="addForm">
          ...
          <div class="input-control mb-3">
            <input type="text" class="form-control" id="validateProduct" placeholder="What is the type your of donated product?" required />
            <div class="error"></div>
          </div>
          <div class="input-control mb-3">
            <textarea class="form-control" rows="3" placeholder="Write product description" required></textarea>
          </div>
